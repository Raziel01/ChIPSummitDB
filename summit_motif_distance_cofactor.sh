...
cd /molbio/projects/rSNP/newanalysis/jaspar_motifs/new_analysis_2017/cofactors;
...
for n in /molbio/projects/rSNP/newanalysis/jaspar_motifs/analysis/statistics_old/summit_stat/global_analysis/summit_pool/hs_all_transcriptionfactor_summits_filtered_2017_02_23_cofactor/hs_all_transcriptionfactor_summits_filtered_2017_02_23_splitted*;
do
		 if [ $isEvenNo -eq 0 ]
			then
